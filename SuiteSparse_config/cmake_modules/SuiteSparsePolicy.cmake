...
# This must be done before loading Fortran and the BLAS
...
if ( SUITESPARSE_USE_OPENMP )
    ...
    if ( "${OpenMP_C_LIBRARIES}" MATCHES "libgomp" )
        # ensure the MKL also uses the GNU OpenMP
        message ( STATUS "Using GNU OpenMP" )
        set ( MKL_THREADING "gnu_thread" )
    elseif ( "${OpenMP_C_LIBRARIES}" MATCHES "libiomp" )
        # ensure the MKL also uses the Intel OpenMP
        message ( STATUS "Using Intel OpenMP" )
        set ( MKL_THREADING "intel_thread" )
    elseif ( "${OpenMP_C_LIBRARIES}" MATCHES "libomp" )
        message ( STATUS "Using Clang OpenMP" )
    else ( )
        message ( STATUS "Using other OpenMP" )
    endif ( )
